...
<!--loading页结束-->
	<body>
		<form action="reginsert.php" method="post" class="login clearfloat box-s">
			<h3>会员注册</h3>
			<div class="list clearfloat">
				<ul>
					...
					<li class="ra3">
						...
						<div class="nr clearfloat fl">
							<span class="opa3"></span>
							<input type="text" name="password" id="password" value="" placeholder="登录密码" />
						</div>
					</li>
					<li class="ra3">
						<p class="fl clearfloat">
						...
						<div class="nr clearfloat fl">
							<span class="opa3"></span>
							<input type="text" name="repassword" id="repassword" value="" placeholder="确定密码" />
						</div>
					</li>
					<li class="ra3">
						<p class="fl clearfloat">
						...
						<div class="nr clearfloat fl">
							<span class="opa3"></span>
							<input type="text" name="tel" id="tel" value="" placeholder="联系电话" />
						</div>
					</li>
			...
			<div class="login-btn">
				<input type="submit" class='reg' value='注册' style='width: 100px;margin-left: 10px;'/>
			</div>
		...
		<footer class="page-footer fixed-footer" id="footer">
			<ul>
				...
				<li class="active">
					<a href="cation.php" class="a1">
						<i class="iconfont icon-icon04"></i>
						<p>分类</p>
					</a>
				</li>
				<li>
					<a href="shopcar/shopcar.php" class="a1">
						<i class="iconfont icon-gouwuche"></i>
						<p>购物车</p>
					</a>
				</li>
				<li>
					<a href="login.php" class="a1">
						<i class="iconfont icon-yonghuming"></i>
						<p>我的</p>
					</a>
				</li>
...
<script type="text/javascript">
	...
	$('.reg').click(function(){
		if($('#username').val()==''){
			...
			alert('手机号不能为空');
			return false;
		}else if(!(/^1[345789]\d{9}$/.test($('#tel').val()))){
			alert('手机号必须为11位有效号码');
			return false;
		}else{
			if($('.db').html() == $('.code').val()){
