...
if(!$_SESSION['admin_userid']){
    ...
    $smtBrand=$pdo->prepare($sqlBrand);
    $smtBrand->execute();
    $rowsBrand=$smtBrand->fetchAll();
    ...
    <!-- <div class="container"> -->
        ...
        <form action="update.php" method='post'>
            ...
            <div class="form-group">
                ...
                <input type="text" name='name' class="form-control" value="<?php echo $rowShop['name']?>"> 
            </div>
            <div class="form-group">
                <label for="">商品库存：</label>
                <input type="text" name='stock' class="form-control" value="<?php echo $rowShop['stock']?>" > 
            </div>
           
            <div class="form-group">
                <label for="">价格：</label>
                <input type="text" name='price' class="form-control" value="<?php echo $rowShop['price']?>"> 
            </div>
            <div class="form-group>
               <label for="">上下架：</label>
               <div class="radio">
                ...
                ?>
                        ...
                        <label><input type="radio" name='shelf'  value='0' > 下架</label>
                <?php    
                        }else{
                ?>
            ...
            <div class="form-group">
                <p>当前商品图片：</p>
                <p><img src="../public/upload/<?php echo $rowShop['img']?>" name='img' width='60px' height='60px'> </p>
            </div>
            <div class="form-group">
